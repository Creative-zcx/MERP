...
def get_args(description='Multi-modal Multi-label Emotion Recognition'):
    ...
    parser.add_argument("--data_path", default=r'..\..\Data\train_valid_test.pt', type=str, help='cmu_mosei data_path')
    parser.add_argument("--missing_prob", default=0.2, type=float, help='single modality missing prob')
    ...
    parser.add_argument("--local_rank", default=int(os.environ.get("LOCAL_RANK", 0)), type=int, help="distribted training") 
    ...
    parser.add_argument('--moco_queue', type=int, default=768)
    ...
    parser.add_argument('--l2_weight', type=float, default=0.01, help='L2 weight decay')
    
    # 添加 Perceiver-IO 相关参数
    parser.add_argument('--num_latents', type=int, default=80, 
                        help='Number of latent vectors in Perceiver-IO (default: 60)')
    parser.add_argument('--num_self_attends', type=int, default=6, 
                        help='Number of self-attention layers per block (default: 6)')
    parser.add_argument('--num_blocks', type=int, default=1,
                        help='Number of Perceiver blocks (default: 1)')
    parser.add_argument('--fourier_num_bands', type=int, default=32,
                        help='Number of frequency bands for position encoding (default: 32)')
    
    # 添加 Dropout 相关参数
    parser.add_argument('--dropout', type=float, default=0.2,
                        help='Additional feature dropout applied to latent features (default: 0.0)')
    
    # 添加自适应网络配置
    parser.add_argument('--gate_hidden_dim', type=int, default=32,
                        help='Hidden dimension for gate networks (default: 32)')
    ...
    output_path = os.path.join(output_path, 'carat_sd{}_t{}_id{}_{}').format(
        args.seed, 
    ...
    if args.do_train:
        ...
        for epoch in range(args.epochs):
            ...
            if args.local_rank == 0:
                ...
                logger.info("val res: f1 %f,\tp %f,\tr %f,\tacc %f.",
                ...
                if best_score <= comp_score:
                    ...
                    logger.info("test res: f1 %f,\tp %f,\tr %f,\tacc %f.",
